  ...
  return (
    <main style={{ position: "relative" }}>
      ...
      <div aria-hidden style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", top: "-15%", left: "-8%", width: "70vw", height: "70vw", borderRadius: "50%", background: "radial-gradient(circle, rgba(60,60,180,.16) 0%, transparent 65%)", filter: "blur(90px)" }} />
        <div style={{ position: "absolute", top: "35%", right: "-12%", width: "60vw", height: "60vw", borderRadius: "50%", background: "radial-gradient(circle, rgba(50,30,120,.12) 0%, transparent 68%)", filter: "blur(110px)" }} />
        <div style={{ position: "absolute", bottom: "-5%", left: "15%", width: "50vw", height: "50vw", borderRadius: "50%", background: "radial-gradient(circle, rgba(30,50,100,.1) 0%, transparent 65%)", filter: "blur(95px)" }} />
      </div>
        ...
        <div style={C}>
          <FadeIn>
            ...
            <h1 style={{ fontFamily: "Inter,ui-sans-serif,sans-serif", fontSize: "clamp(56px,9vw,112px)", fontWeight: 800, letterSpacing: "-.055em", lineHeight: .9, color: "rgba(255,255,255,.92)", marginBottom: 52 }}>
              CAIMAN<br />
              {/* Adjusted LAB contrast */}
              <span style={{ color: "rgba(255,255,255,.22)", WebkitTextStroke: "1px rgba(255,255,255,.14)" }}>LAB</span>
            </h1>
          ...
          <FadeIn>
            <div className="explore-wrap">
              <div className="explore-grid">
                <div className="explore-cell explore-animate" style={{ background: "linear-gradient(160deg, rgba(255,255,255,.07) 0%, rgba(255,255,255,.04) 100%)" }}> {/* Added subtle gradient */}
              ...
              <div className="explore-full explore-animate" style={{ background: "linear-gradient(160deg, rgba(255,255,255,.06) 0%, rgba(255,255,255,.03) 100%)" }}> {/* Added subtle gradient */}
      ...
      {/* ── Footer ── */}
      <footer style={{ position: "relative", zIndex: 1, borderTop: "1px solid rgba(255,255,255,.07)", backdropFilter: "blur(32px)" }}>
        <div style={{ ...C, height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 20, alignItems: "center" }}> {/* Adjusted gap */}
            <a href="https://github.com/caiman001" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.35)", display: "flex", lineHeight: 0, transition: "color .2s" }}> {/* Adjusted color */}
            ...
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,.35)", display: "flex", lineHeight: 0, transition: "color .2s" }}> {/* Adjusted color */}
